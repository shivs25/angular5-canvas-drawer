...
Date: `2018-12-14` VERSION: `1.2.1-beta.777`
- Attempted upgrade to Angular 7


Date: `2018-08-07` VERSION: `1.2.1-beta.1`
- Trying to figure out how to make things work with another library that is using redux.
