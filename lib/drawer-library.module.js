...
var DrawerLibraryModule = /** @class */ (function () {
    ...
    DrawerLibraryModule.forRoot = function () {
        return { ngModule: DrawerLibraryModule, providers: [{ provide: core_1.ComponentFactoryResolver, useValue: core_1.ComponentFactoryResolver }] };
    };
