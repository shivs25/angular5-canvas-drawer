...
var DynamicSvgDirective = /** @class */ (function () {
    ...
    DynamicSvgDirective.prototype.buildComponent = function (data) {
        if (!this.allowCustomComponents || null === data.customType || 0 === data.customType.length) {
            switch (data.drType) {
                ...
                case dr_type_enum_1.DrType.POINT:
                    return dr_point_component_1.DrPointComponent;
            }
        }
        else {
    ...
    ], DynamicSvgDirective.prototype, "allowCustomComponents", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ], DynamicSvgDirective.prototype, "hoverClass", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], DynamicSvgDirective.prototype, "overrideProperties", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], DynamicSvgDirective.prototype, "elementId", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], DynamicSvgDirective.prototype, "canInteract", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], DynamicSvgDirective.prototype, "click", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], DynamicSvgDirective.prototype, "mouseDown", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], DynamicSvgDirective.prototype, "mouseMove", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], DynamicSvgDirective.prototype, "mouseUp", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], DynamicSvgDirective.prototype, "componentData", null);
    DynamicSvgDirective = __decorate([
        core_1.Directive({
            selector: '[dynamic-svg]'
        }),
        __metadata("design:paramtypes", [core_1.ViewContainerRef, core_1.ComponentFactoryResolver, custom_component_resolver_service_1.CustomComponentResolverService])
    ], DynamicSvgDirective);
