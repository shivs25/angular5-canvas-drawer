...
var DrawerLibraryRootModule = (function () {
    ...
    DrawerLibraryRootModule.decorators = [
        { type: core_1.NgModule, args: [{
                    imports: [
                        ...
                        editor_module_1.EditorModule.forRoot()
                    ],
                    exports: [
...
var DrawerLibraryModule = (function () {
    ...
    DrawerLibraryModule.decorators = [
        { type: core_1.NgModule, args: [{ imports: [drawer_module_1.DrawerModule.forRoot(), common_1.CommonModule], exports: [common_1.CommonModule, drawer_module_1.DrawerModule] },] },
    ];
    /** @nocollapse */
