...
var ObjectCreationToolComponent = (function () {
    ...
    ObjectCreationToolComponent.prototype.createCallout = function (evt) {
        ...
        this.currentObject = dr_polygon_1.createDrPolygon({
            ...
            stroke: 'red',
            points: [
                { x: b.x + b.width * 1, y: b.y + b.height * 0.08 },
                //Top of star
    ...
    ObjectCreationToolComponent.prototype.createRect = function (evt, rounded) {
