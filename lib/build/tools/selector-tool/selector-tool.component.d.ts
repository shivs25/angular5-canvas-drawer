...
export declare class SelectorToolComponent implements OnInit, OnDestroy {
    ...
    finalize(): void;
    private microMoveObjects;
    private getDistanceBetweenTwoPoints;
    private getRelativeChildPointFromEvent;
    private getRelativePointFromEvent;
    private canAllResize;
    private setupBounds;
    private rotateObject;
    private getRotationAngle;
    private getRotationAngleFromMouseDownPoint;
