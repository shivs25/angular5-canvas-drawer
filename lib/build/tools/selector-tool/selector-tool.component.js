...
var SelectorToolComponent = /** @class */ (function () {
    function SelectorToolComponent(_dataStoreService, _objectHelperService, _changeService, _elementRef, _customComponentResolverService) {
        ...
        this._customComponentResolverService = _customComponentResolverService;
    ...
    SelectorToolComponent.prototype.finalize = function () {
        //Not Implemented
    };
        ...
        if (null !== this._dataStoreService.selectedBounds && this._dataStoreService.selectedObjects.length > 0) {
            ...
            if (1 === this.selectedObjects.length) {
                if (null !== this.selectedObjects[0].customType) {
                    ...
                    this.canRotate = enums_1.DrType.GROUPED_OBJECT !== this.selectedObjects[0].drType && enums_1.DrType.CALLOUT !== this.selectedObjects[0].drType;
                }
            }
            else {
                this.canRotate = false;
    ...
    ], SelectorToolComponent.prototype, "onKeyDown", null);
    __decorate([
        core_1.HostListener('window:keyup', ['$event']),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", void 0)
    ], SelectorToolComponent.prototype, "onKeyUp", null);
    SelectorToolComponent = __decorate([
        core_1.Component({
        ...
        __metadata("design:paramtypes", [data_store_service_1.DataStoreService,
            ...
            core_1.ElementRef,
            custom_component_resolver_service_1.CustomComponentResolverService])
