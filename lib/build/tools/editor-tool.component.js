...
var EditorToolComponent = /** @class */ (function () {
    function EditorToolComponent(_dataService) {
        ...
        this.POINT_TOOL = enums_1.EditorToolType.POINT_TOOL;
        this.TEXT_EDIT_TOOL = enums_1.EditorToolType.TEXT_EDIT_TOOL;
        this.CALLOUT_POINTER_TOOL = enums_1.EditorToolType.CALLOUT_POINTER_TOOL;
    }
    ...
    ], EditorToolComponent.prototype, "pointStyle", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], EditorToolComponent.prototype, "polygonStyle", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], EditorToolComponent.prototype, "lineStyle", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ], EditorToolComponent.prototype, "penDblClick", void 0);
    __decorate([
        store_1.select(),
        __metadata("design:type", Object)
    ], EditorToolComponent.prototype, "elementState", void 0);
    EditorToolComponent = __decorate([
        core_1.Component({
            selector: 'app-editor-tool',
            template: "\n    <app-selector-tool *ngIf=\"SELECTOR_TOOL === (elementState | async)?.present.selectedTool\"></app-selector-tool>\n    <app-pen-tool *ngIf=\"PEN_TOOL === (elementState | async)?.present.selectedTool\"\n                        [polygonStyle]=\"polygonStyle\" [lineStyle]=\"lineStyle\" [penDblClick]=\"penDblClick\"></app-pen-tool>\n    <app-object-creation-tool *ngIf=\"shouldShowCreationTool()\"\n                        [polygonStyle]=\"polygonStyle\"></app-object-creation-tool>\n    <app-text-edit-tool *ngIf=\"TEXT_EDIT_TOOL === (elementState | async)?.present.selectedTool\"></app-text-edit-tool>\n    <app-callout-point-tool *ngIf=\"CALLOUT_POINTER_TOOL === (elementState | async)?.present.selectedTool\"></app-callout-point-tool>\n    <app-point-tool *ngIf=\"POINT_TOOL === (elementState | async)?.present.selectedTool\"\n                        [pointStyle]=\"pointStyle\"></app-point-tool>\n  ",
            styles: ["\n\n  "]
        }),
