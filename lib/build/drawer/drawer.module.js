...
var DrawerModule = /** @class */ (function () {
    ...
    DrawerModule.forRoot = function () { return { ngModule: DrawerModule, providers: [change_helper_service_1.ChangeHelperService, drawer_object_helper_service_1.DrawerObjectHelperService, data_store_service_1.DataStoreService, dynamic_svg_directive_1.DynamicSvgDirective] }; };
    DrawerModule.decorators = [
        { type: core_1.NgModule, args: [{
                    ...
                    exports: [drawer_component_1.DrawerComponent, dynamic_svg_directive_1.DynamicSvgDirective],
                    providers: [change_helper_service_1.ChangeHelperService, drawer_object_helper_service_1.DrawerObjectHelperService, data_store_service_1.DataStoreService, dynamic_svg_directive_1.DynamicSvgDirective],
                    entryComponents: [
                        dr_rect_component_1.DrRectComponent,
                        dr_ellipse_component_1.DrEllipseComponent,
                        dr_polygon_component_1.DrPolygonComponent,
