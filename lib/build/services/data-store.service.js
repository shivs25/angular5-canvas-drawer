...
var drawer_object_helper_service_1 = require("./drawer-object-helper.service");
...
var DataStoreService = /** @class */ (function () {
    function DataStoreService(_ngRedux, _objectHelperService, _changeService, _textRenderService) {
        ...
        this.toolChanged = new core_1.EventEmitter();
    ...
    //=========Actions=========
    DataStoreService.prototype.setHideSelection = function (hide) {
    ...
    DataStoreService.prototype.setInitialUrls = function (items, url) {
        this._ngRedux.dispatch({
            type: actions_1.SET_INITIAL_URLS,
            changes: items.map(function (x) {
    ...
    DataStoreService.prototype.overWriteObject = function (item) {
        this._ngRedux.dispatch({
            type: actions_1.OVERWRITE_OBJECT,
            newObject: item
        });
    };
    ...
    //=========Selection========
    DataStoreService.prototype.selectObjects = function (items) {
        this._ngRedux.dispatch({
            type: actions_1.SELECT_OBJECTS,
            items: items,
            selectedBounds: items.length > 0 ?
    ...
    Object.defineProperty(DataStoreService.prototype, "undoLength", {
        get: function () {
    ...
    Object.defineProperty(DataStoreService.prototype, "redoLength", {
        get: function () {
    ...
    DataStoreService.prototype.clearHistory = function () {
        this._ngRedux.dispatch(redux_undo_1.ActionCreators.clearHistory());
    };
    //=========Supporting Functions=========
    DataStoreService.prototype.getObjects = function (ids) {
