...
var CustomComponentResolverService = /** @class */ (function () {
    ...
    CustomComponentResolverService.ngInjectableDef = i0.ɵɵdefineInjectable({ factory: function CustomComponentResolverService_Factory() { return new CustomComponentResolverService(); }, token: CustomComponentResolverService, providedIn: "root" });
    CustomComponentResolverService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [])
    ], CustomComponentResolverService);
