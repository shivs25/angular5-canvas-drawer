...
var DrawerObjectHelperService = /** @class */ (function () {
    ...
    DrawerObjectHelperService.prototype.getObjectsAtPoint = function (elements, x, y) {
        ...
        for (var _a = 0, bBoxObjects_1 = bBoxObjects; _a < bBoxObjects_1.length; _a++) {
            ...
            var rotatedY = y;
            if (e.rotation !== 0) {
                var rotatedXY = this.getRotatedPointForSinglePoint(rotatedX, rotatedY, e);
                ...
                case dr_type_enum_1.DrType.POLYGON:
                    {
                        ...
                        if (p.isClosed) {
                            ...
                            if (allYMatch || allXMatch) {
                                ...
                                var inpoly = this.clipper.pointInPolygon({ x: rotatedX, y: y }, poly);
                                if (0 !== inpoly) {
                                    returnValue.push(e);
                                }
                            }
    ...
    DrawerObjectHelperService.prototype.getRotatedPointForSinglePoint = function (x, y, item) {
