...
exports.elementsReducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case actions_1.OVERWRITE_OBJECT: {
            return Object.assign({}, state, {
        ...
        case actions_1.SET_INITIAL_URLS: {
            return Object.assign({}, state, {
                elements: findAndReplaceNestedItems(state.elements, action.changes)
            });
        }
        ...
        case actions_1.REPLACE_OBJECTS: {
            ...
            var filteredElements = newElements.filter(function (x) { return idsToRemove_1.indexOf(x.id) < 0; });
            console.log(idsToRemove_1);
...
var ACTIONS_TO_IGNORE = [
    ...
    actions_1.SET_INITIAL_URLS,
    actions_1.OVERWRITE_OBJECT
];
