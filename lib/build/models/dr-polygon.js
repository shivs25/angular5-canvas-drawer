...
exports.DEFAULT_POLYLINE = Object.assign({}, dr_styled_object_1.DEFAULT_STYLED_OBJECT, {
    points: [],
    isClosed: false,
    drType: dr_type_enum_1.DrType.POLYGON
});
...
function createDrPolyline(properties) {
    return Object.assign({}, exports.DEFAULT_POLYLINE, properties);
}
exports.createDrPolyline = createDrPolyline;
